...
<div class="card viewcard" style="width: 18rem;">
    <h5 class="card-title"> From:<?php echo $result['name']; ?> </h5>
    <p class="card-text">Subject: <?php echo $result['subject']; ?></p>

    <p class="card-text">Email: <?php echo $result['email']; ?></p>

    <p class="card-text">Message: <?php echo $result['message']; ?></p>
